...
class ListCarousel2 extends StatelessWidget {
  const ListCarousel2({Key? key}) : super(key: key);
                ...
                margin: EdgeInsets.only(top: 10),
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ListCarousel3()));
                        },
                        child: Container(
